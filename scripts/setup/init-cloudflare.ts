...
async function setupCloudflareResources() {
  ...
  await runCommand(
    "npx wrangler vectorize create opendiscourse-vector-index --dimensions=768 --metric=cosine",
  );
  ...
  console.log(
    "Please update your .env.local file with the generated IDs and secrets.",
  );
}
