...
async function testAgenticGraph() {
  ...
  const testDocument = {
    id: "test-doc-1",
    content:
      "Senator Smith introduced H.R. 1234, a bill to improve healthcare access. The 118th Congress has been actively discussing this legislation. Senator Johnson co-sponsored the bill, showing bipartisan support.",
    source: "test",
    metadata: {
      date: "2023-01-01",
      type: "bill",
