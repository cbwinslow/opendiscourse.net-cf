...
async function generateTimelineData() {
  ...
  return {
    ...
    data: [
      {
        date: "2023-01-15",
        event: "Introduction of HR 123 - Digital Privacy Act",
        type: "bill_introduced",
        count: 1,
      },
      {
        date: "2023-03-22",
        event: "Committee Hearings Begin",
        type: "hearing",
        count: 3,
      },
      {
        date: "2023-06-10",
        event: "Mark-up Session Completed",
        type: "markup",
        count: 1,
      },
      {
        date: "2023-09-05",
        event: "Bill Reported to Floor",
        type: "reported",
        count: 1,
      },
      {
        date: "2024-02-18",
        event: "Floor Debate Begins",
        type: "debate",
        count: 1,
      },
      ...
      {
        date: "2024-08-12",
        event: "Introduction of S 456 - Federal Privacy Protection Act",
        type: "bill_introduced",
        count: 1,
      },
      {
        date: "2024-11-25",
        event: "Senate Committee Hearings",
        type: "hearing",
        count: 2,
      },
      {
        date: "2025-01-30",
        event: "Introduction of HR 1234 - American Data Privacy Act",
        type: "bill_introduced",
        count: 1,
      },
      {
      ...
      {
        date: "2025-04-02",
        event: "Bill Reported from Committee",
        type: "reported",
        count: 1,
      },
      {
        date: "2025-06-15",
        event: "Anticipated Floor Consideration",
        type: "scheduled",
        count: 1,
      },
    ],
...
async function generateNetworkData() {
  ...
  return {
    title:
      "Congressional Network - Privacy Legislation Sponsors and Cosponsors",
    nodes: [
      {
        id: "smith_jane",
        label: "Rep. Jane Smith (D-CA)",
        type: "sponsor",
        size: 30,
        color: "#FF6B6B",
      },
      ...
      {
        id: "energy_commerce",
        label: "Energy and Commerce Committee",
        type: "committee",
        size: 25,
        color: "#1A535C",
      },
...
async function generateVisualizations() {
  try {
    ...
    console.log(
      "   Time range:",
      timelineData.data[0].date,
      "to",
      timelineData.data[timelineData.data.length - 1].date,
    );
    ...
    console.log(
      "   Top topic:",
      barChartData.data[0].topic,
      `(${barChartData.data[0].percentage}%)`,
    );
    ...
    console.log(
      "   Majority party:",
      pieChartData.data[0].party,
      `(${pieChartData.data[0].percentage}%)`,
    );
    ...
    console.log(
      "   Data points:",
      heatmapData.xAxis.length * heatmapData.yAxis.length,
    );
    ...
    console.log(
      "You can view them by opening the HTML files in a web browser.",
    );
  } catch (error) {
